...
import com.food.ordering.system.kafka.consumer.config.KafkaSingleItemConsumer;
...
public class PaymentRequestKafkaListener implements KafkaSingleItemConsumer<Envelope> {
    ...
    public PaymentRequestKafkaListener(PaymentRequestMessageListener paymentRequestMessageListener, PaymentMessagingDataMapper paymentMessagingDataMapper, KafkaMessageHelper kafkaMessageHelper) {
    ...
    public void receive(@Payload Envelope message,
        ...
        log.info("{} number of payment requests received with keys:{}, partitions:{}, offsets:{}", message, key,
                partition, offset);
