...
public class OrderOutboxScheduler implements OutboxScheduler {
    ...
    // @Scheduled olunca bu methodun belirli aralıklarla çalıştırılacağını belirtiyoruz.
    // fixedRateString ile belirli bir süre aralığında çalıştırılacağını belirtiyoruz.
    // initialDelayString ile ilk çalıştırmanın ne zaman yapılacağını belirtiyoruz.
    // 10000 değeri 10 saniye demektir. 1000 değeri 1 saniye demektir.
