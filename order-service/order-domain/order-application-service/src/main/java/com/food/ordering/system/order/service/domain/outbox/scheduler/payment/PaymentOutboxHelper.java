...
public class PaymentOutboxHelper {
    ...
    @Transactional
    public void savePaymentOutboxMessage(OrderPaymentEventPayload paymentEventPayload, OrderStatus orderStatus, SagaStatus sagaStatus, OutboxStatus outboxStatus,
                                         UUID sagaId){
    ...
    public void save(OrderPaymentOutboxMessage orderPaymentOutboxMessage){
        OrderPaymentOutboxMessage paymentOutboxMessage = paymentOutboxRepository.save(orderPaymentOutboxMessage);
