...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public OrderPaymentSaga(OrderDomainService orderDomainService, OrderSagaHelper orderSagaHelper, PaymentOutboxHelper paymentOutboxHelper, OrderRepository orderRepository, ApprovalOutboxHelper approvalOutboxHelper, OrderDataMapper orderDataMapper) {
    ...
    public void process(PaymentResponse paymentResponse) {
        ...
        log.info("Order with id : {} paid successfully", domainEvent.getOrder().getId().getValue());
    }
