        ...
        messages.forEach(paymentResponseAvroModel -> {
            try {
                if (PaymentStatus.COMPLETED == paymentResponseAvroModel.getPaymentStatus()){
                    ...
                    log.info("Processing failed payment response for order id:{}", paymentResponseAvroModel.getOrderId());
                ...
                log.error("Order not found for order id: {}", paymentResponseAvroModel.getOrderId());
            }
        });
    }
}
