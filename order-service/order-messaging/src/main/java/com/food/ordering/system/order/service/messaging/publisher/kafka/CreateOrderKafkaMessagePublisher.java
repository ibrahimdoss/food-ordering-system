...
public class CreateOrderKafkaMessagePublisher implements OrderCreatedPaymentRequestMessagePublisher {
    ...
    public void publish(OrderCreatedEvent domainEvent){
        ...
        try {
            ...
            log.info("PaymentRequestAvroModel sent to kafka topic: {} with message: {}", paymentRequestAvroModel.getOrderId(), paymentRequestAvroModel.toString());
        }catch (Exception e) {
            log.error("Error while sending message to kafka topic: {} and message: {}", orderId, e.getMessage());
        }
    }
