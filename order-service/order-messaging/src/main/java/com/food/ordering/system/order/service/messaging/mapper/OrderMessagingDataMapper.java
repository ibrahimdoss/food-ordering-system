...
public class OrderMessagingDataMapper {
    ...
    public PaymentRequestAvroModel orderCreatedEventToPaymentRequestAvroModel(OrderCreatedEvent orderCreatedEvent){
        ...
        return PaymentRequestAvroModel.newBuilder()
                ...
                .setCreatedAt(orderCreatedEvent.getCreatedDate().toInstant())
    ...
    public PaymentRequestAvroModel orderCancelledEventToPaymentRequestAvroModel(OrderCancelledEvent orderCancelledEvent){
        ...
        return PaymentRequestAvroModel.newBuilder()
                ...
                .setOrderId(order.getId().getValue().toString())
                .setPrice(order.getPrice().getAmount())
                .setCreatedAt(orderCancelledEvent.getCreatedDate().toInstant())
    ...
    public RestaurantApprovalRequestAvroModel orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent){
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setProducts(order.getItems().stream().map(orderItem -> Product.newBuilder()
                        ...
                        .build()).toList())
                .setPrice(order.getPrice().getAmount())
                .setCreatedAt(orderPaidEvent.getCreatedDate().toInstant())
